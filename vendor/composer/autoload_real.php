...
class ComposerAutoloaderInitbc672b800f2e5da6256663da640aab98
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitbc672b800f2e5da6256663da640aab98::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequirebc672b800f2e5da6256663da640aab98($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequirebc672b800f2e5da6256663da640aab98($fileIdentifier, $file)
{
