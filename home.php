...
<div class="row">
	...
	<div class="card">
  <a style="text-decoration:none" href="product.php?id=<?php echo  $id ;?>"><img src="img/<?php echo $a;?>"  style="width:150px;height:150px;"></a>
  <p font face="Bookman Old Style" name="Item"><?php echo $b;?></p>
  <p class="price" name="Price">₹ <?php echo $c;?></p>
